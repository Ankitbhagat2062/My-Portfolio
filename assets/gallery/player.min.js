...
!function(e, t) {
    ...
    function o(e) {
        var t, n = 0 < arguments.length && void 0 !== e ? e : {}, o = n.id, i = n.url, a = o || i;
        if (!a)
        ...
        if (o)
            throw new TypeError("“".concat(o, "” is not a valid video id."));
    ...
    var u, l, c, s = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {};
    function f() {
        if (void 0 === this)
            throw new TypeError("Constructor WeakMap requires 'new'");
        if (c(this, "_id", "_WeakMap_" + h() + "." + h()),
        0 < arguments.length)
    ...
    (u = "undefined" != typeof self ? self : "undefined" != typeof window ? window : s).WeakMap || (l = Object.prototype.hasOwnProperty,
    c = function(e, t, n) {
    ...
    ,
    u.WeakMap = (c(f.prototype, "delete", (function(e) {
        if (d(this, "delete"),
        !m(e))
            return !1;
        var t = e[this._id];
    ...
    c(f.prototype, "set", (function(e, t) {
        ...
        var n = e[this._id];
        return n && n[0] === e ? n[1] = t : c(e, this._id, [e, t]),
        this
    }
    )),
    c(f, "_polyfill", !0),
    ...
    var v, p = (function(e) {
        var t, n, r;
        r = function() {
            var e, t, n, r, o, i, a = Object.prototype.toString, u = "undefined" != typeof setImmediate ? function(e) {
            ...
            return e(y.prototype = g, "__NPO__", 0, !1),
            ...
            e(y, "all", (function(e) {
                var t = this;
                return "[object Array]" != a.call(e) ? t.reject(TypeError("Not an array")) : 0 === e.length ? t.resolve([]) : new t((function(n, r) {
            ...
            e(y, "race", (function(e) {
                var t = this;
                return "[object Array]" != a.call(e) ? t.reject(TypeError("Not an array")) : new t((function(n, r) {
                    if ("function" != typeof n || "function" != typeof r)
                        throw TypeError("Not a function");
                    m(t, e, (function(e, t) {
                        n(t)
    ...
    function P(e, t, n) {
        ...
        return new Promise((function(t, n) {
            ...
            for (var u in o)
                o.hasOwnProperty(u) && (a += "&".concat(u, "=").concat(encodeURIComponent(o[u])));
            ...
            l.onload = function() {
                if (404 !== l.status)
                    if (403 !== l.status)
                        ...
                        n(new Error("“".concat(e, "” is not embeddable.")));
                else
                    n(new Error("“".concat(e, "” was not found.")))
            }
            ,
            l.onerror = function() {
    ...
    var N, F, x, C = new WeakMap, j = new WeakMap, A = {}, q = function() {
        function t(e) {
            var n, i, a = this, u = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {};
            if (function(e, t) {
                if (!(e instanceof t))
                    throw new TypeError("Cannot call a class as a function")
            }(this, t),
            window.jQuery && e instanceof jQuery && (1 < e.length && window.console && console.warn && console.warn("A jQuery object with multiple elements was passed, using the first element."),
            e = e[0]),
            "undefined" != typeof document && "string" == typeof e && (e = document.getElementById(e)),
            n = e,
            !Boolean(n && 1 === n.nodeType && "nodeName"in n && n.ownerDocument && n.ownerDocument.defaultView))
                throw new TypeError("You must pass either a valid element or a valid id.");
            if ("IFRAME" === e.nodeName || (i = e.querySelector("iframe")) && (e = i),
            ...
            var l, c = new p((function(t, n) {
                ...
                a._onMessage = function(e) {
                    if (r(e.origin) && a.element.contentWindow === e.source) {
                        ...
                        !function(e, t) {
                            var n, r, o = [];
                            (t = _(t)).event ? ("error" === t.event && w(e, t.data.method).forEach((function(n) {
                            ...
                            n = t.data) : !t.method || (r = function(e, t) {
                                var n = w(e, t);
                                if (n.length < 1)
                                    return !1;
                                var r = n.shift();
                ...
                "IFRAME" !== a.element.nodeName && P(o(i = E(e, u)), i, e).then((function(t) {
                    var n, r, o, i = T(t, e);
                    return a.element = i,
            ...
            A.isEnabled && (l = function() {
                return A.exit()
            }
            ,
            A.on("fullscreenchange", (function() {
                (A.isFullscreen ? g : b)(a, "event:exitFullscreen", l),
                a.ready().then((function() {
                    M(a, "fullscreenchange", A.isFullscreen)
                }
                ))
            }
            ))),
        ...
        (a = [{
            ...
            key: "ready",
            value: function() {
                var e = j.get(this) || new p((function(e, t) {
            ...
            key: "getFullscreen",
            value: function() {
                return A.isEnabled ? p.resolve(A.isFullscreen) : this.get("fullscreen")
            }
        }, {
            ...
            value: function() {
                ...
                return new p((function(t) {
                    ...
                    j.delete(e),
                    C.delete(e.element),
                    e._originalElement && (C.delete(e._originalElement),
                    ...
                    e.element && "DIV" === e.element.nodeName && e.element.parentNode && (e.element.removeAttribute("data-vimeo-initialized"),
                    (n = e.element.querySelector("iframe")) && n.parentNode && (n.parentNode.parentNode && e._originalElement && e._originalElement !== n.parentNode ? n.parentNode.parentNode.removeChild(n.parentNode) : n.parentNode.removeChild(n))),
    ...
    x = {
        request: function(e) {
            return new Promise((function(t, n) {
                function r() {
                    x.off("fullscreenchange", r),
                    t()
                }
                x.on("fullscreenchange", r);
                var o = (e = e || document.documentElement)[N.requestFullscreen]();
        ...
        exit: function() {
            return new Promise((function(e, t) {
                var n, r;
                x.isFullscreen ? (n = function t() {
                    x.off("fullscreenchange", t),
                    e()
                }
                ,
                x.on("fullscreenchange", n),
                (r = document[N.exitFullscreen]())instanceof Promise && r.then(n).catch(t)) : e()
            }
            ))
        },
        on: function(e, t) {
    ...
    function(e) {
        ...
        window.addEventListener("message", (function(e) {
            if (r(e.origin) && e.data && "spacechange" === e.data.event)
                for (var n = t.querySelectorAll("iframe"), o = 0; o < n.length; o++)
                    if (n[o].contentWindow === e.source) {
                        n[o].parentElement.style.paddingBottom = "".concat(e.data.data[0].bottom, "px");
                        break
                    }
        }
        )))
